...
* You need [.bashrc](https://github.com/geodesymiami/rsmas_insar/blob/master/docs/bashrc_contents) and [.bash_profile](https://github.com/geodesymiami/rsmas_insar/blob/master/docs/bash_profile_contents)
